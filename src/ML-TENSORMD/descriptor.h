...
template <typename Scalar> class Descriptor {
 ...
 protected:
  Memory *memory;
  Error *error;
  Descriptor_fn method;    // the descriptor function
  Scalar **params;    // params is a two-dimensional array with shape [d0, d1]
  int d0;             // d0 represents the number of parameters.
  int d1;             // d1 is the number of parameter sets.
  Scalar rmax;        // the cutoff radius

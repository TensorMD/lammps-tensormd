...
class NeuralNetworkPotential {
 public:
  ...
  void get_sw_nnp_config(int *use_resnet, int *nlayers, int max_layer, int max_col,
                  int **layer_sizes, int **input_sizes, Scalar **bias,
                  Scalar **last_kernel, Scalar **kernel_matrix_T,
                  Scalar **kernel_matrix_bp, int config_id);

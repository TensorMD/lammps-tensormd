...
class NeuralNetworkPotential {
 public:
  ...
  Scalar forward(int elti, Scalar *x_in, int n, Scalar *y, bool DToH = true);
 ...
 protected:
  ...
  bool apply_output_bias;
   ...
   Scalar *weights_GPU;
   Scalar *biases_GPU;
   Scalar *dz_GPU[4] = {nullptr, nullptr, nullptr, nullptr};
  ...
  // Internal functions
  bool sum_output;
  Scalar forward_resnet(int elti, Scalar *x_in, int n, Scalar *y, bool DToH);

                                            ...
                                            Cutoff<Scalar> *cutoff)
{
  ...
  forward_fnn_GPU(x, n, y.data(), this->max_size, this->n_out, this->nlayers, 
                  this->actfn, this->full_sizes, this->apply_output_bias, 
                  this->use_resnet_dt, this->weights_GPU, this->biases_GPU);

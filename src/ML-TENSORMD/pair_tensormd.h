...
class PairTensorMD : public Pair {
 public:
  ...
  void update_etemp(double *vector);
  void enable_atom_etemp();
  double get_average_etemp() { return etemp; }
 ...
 private:
  ...
  void setup_compute(int *typenums);
 ...
 public:
  // TDNP
  int tdpe_flag;
  TDPE<double> tdpe{{0.0, nullptr}, {0.0, nullptr}, {0.0, nullptr}};
};

...
class TensorBase<Derived, ReadOnlyAccessors>
{
  public:
    ...
    EIGEN_DEVICE_FUNC
    EIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_cos_op<Scalar>, const Derived>
    cos() const {
      return unaryExpr(internal::scalar_cos_op<Scalar>());
    }

    EIGEN_DEVICE_FUNC
    EIGEN_STRONG_INLINE const TensorCwiseUnaryOp<internal::scalar_sin_op<Scalar>, const Derived>
    sin() const {
      return unaryExpr(internal::scalar_sin_op<Scalar>());
    }
